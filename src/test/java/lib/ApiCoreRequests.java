...
public class ApiCoreRequests {
    ...
    @Step("Make a POST-request and return json")
    public JsonPath makePostRequestReturnJson(String url, Map<String, String> authData){
        return given()
                .filter(new AllureRestAssured())
                .body(authData)
                .post(url)
    ...
    @Step("Make a PUT-request person data")
